  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-background/90 backdrop-blur-md border-b border-border">
      <div className="max-w-7xl mx-auto px-6 h-18 flex items-center justify-between py-4">
        ...
        {/* Desktop Nav */}
        <div className="hidden md:flex items-center gap-2 text-sm font-medium text-foreground/60">
          <Link href="/" className="px-4 py-2 text-foreground font-semibold relative after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:w-4 after:h-0.5 after:bg-white after:rounded-full">
            Home
          </Link>
          <span className="text-foreground/40">·</span>
          <Link href="#modules" className="px-4 py-2 hover:text-foreground transition-colors">Modules</Link>
          <span className="text-foreground/40">·</span>
          <Link href="#about" className="px-4 py-2 hover:text-foreground transition-colors">About</Link>
          <span className="text-foreground/40">·</span>
          <Link href="#contact" className="px-4 py-2 hover:text-foreground transition-colors">Contact</Link>
        </div>
        ...
        <div className="hidden md:flex items-center gap-3">
          <Link
            href="/dashboard"
            className="px-5 py-2.5 bg-primary text-gray-900 text-sm font-bold rounded-full hover:brightness-110 transition-all"
          >
            Launch Dashboard
          </Link>
        </div>
      ...
      {isOpen && (
        <motion.div
          ...
          className="md:hidden absolute top-full left-0 right-0 bg-background border-b border-border p-6 shadow-2xl flex flex-col gap-4"
        >
          <Link href="/" className="text-foreground font-semibold">Home</Link>
          <Link href="#modules" className="text-foreground/60">Modules</Link>
          <Link href="#about" className="text-foreground/60">About</Link>
          <Link href="#contact" className="text-foreground/60">Contact</Link>
          <Link href="/dashboard" className="w-full text-center py-3 bg-primary text-gray-900 rounded-xl font-bold">
            Launch Dashboard
          </Link>
        </motion.div>
      )}
...
const Col1Card = () => (
  <motion.div
    ...
    className="relative bg-[#0d2b1d] rounded-[1.75rem] p-7 flex flex-col justify-between text-foreground overflow-hidden h-[360px] border border-[#1a4a2a]"
  >
    {/* decorative rings */}
    ...
    <div className="relative z-10">
      <span className="text-7xl font-black leading-none text-primary">6</span>
      <p className="text-sm mt-4 text-green-300/80 leading-relaxed max-w-[150px]">
        Engineering modules — power, water, fire, battery &amp; more
      </p>
    </div>

    <button className="relative z-10 flex items-center justify-between bg-primary text-gray-900 font-bold text-sm px-5 py-3 rounded-full w-full hover:brightness-105 transition-all">
      <span>See all modules</span>
      <span className="w-7 h-7 bg-gray-900 text-primary rounded-full flex items-center justify-center">
...
const Col1Bar = () => (
  <motion.div
    ...
    className="bg-card border border-border rounded-[1.25rem] px-5 py-4 flex items-center gap-3 mt-3"
  >
    <Smile className="w-5 h-5 text-primary shrink-0" />
    <span className="text-foreground text-sm font-bold">Live sensor data</span>
  </motion.div>
);
...
const PhotoCard = ({
  ...
  >
    ...
    <div className="absolute top-5 left-5">
      <span className="bg-background/40 backdrop-blur-sm text-foreground text-xs font-semibold px-3 py-1.5 rounded-full border border-white/15">
        {tag}
      </span>
    </div>
    ...
    <div className="relative z-10 p-6">
      <p className="text-foreground text-lg font-bold leading-snug mb-4">{title}</p>
      <span className="w-8 h-8 bg-white rounded-full flex items-center justify-center hover:bg-primary transition-colors cursor-pointer">
...
const JoinCard = () => (
  <motion.div
    ...
    className="bg-card border border-border rounded-[1.75rem] h-[280px] flex flex-col items-center justify-center text-center p-8"
  >
    <p className="text-foreground text-xl font-black leading-tight mb-1">Official Agency</p>
    <p className="text-foreground text-xl font-black leading-tight mb-6">
      Visit <span className="text-primary">NIWA</span>
    </p>
    <a
      href="https://niwa.gov.ng"
      target="_blank"
      rel="noopener noreferrer"
      className="flex items-center gap-2.5 text-sm font-semibold text-foreground/60 hover:text-foreground transition-colors group"
    >
      <span>Visit NIWA official website</span>
      <span className="w-7 h-7 bg-muted border border-border text-foreground rounded-full flex items-center justify-center group-hover:bg-primary group-hover:text-gray-900 transition-all">
        <ArrowUpRight className="w-4 h-4" />
      </span>
    </a>
  </motion.div>
...
const Col5Card = () => (
  <motion.div
    ...
    transition={{ delay: 0.3, duration: 0.6 }}
    whileHover={{ y: -5 }}
    className="relative bg-background rounded-[2rem] overflow-hidden h-[360px] flex flex-col border border-border group"
  >
    {/* Animated background patterns */}
    <div className="absolute inset-0 pointer-events-none opacity-20">
      <div className="absolute top-0 right-0 w-40 h-40 bg-primary/20 blur-[80px] rounded-full" />
      <div className="absolute bottom-0 left-0 w-40 h-40 bg-primary/10 blur-[60px] rounded-full" />
    </div>
    ...
    <div className="relative flex-1 overflow-hidden">
      ...
      <div className="absolute top-4 left-4">
        <span className="px-3 py-1 rounded-full bg-background/40 backdrop-blur-md border border-white/10 text-[10px] font-black uppercase tracking-[0.2em] text-primary">
          Synergy
        </span>
      </div>
    </div>
    ...
    <div className="p-5 pt-0 relative z-10">
      <div className="mb-4">
        <h4 className="text-foreground font-bold text-lg leading-tight mb-1">Engineering Partnership</h4>
        <p className="text-foreground/50 text-xs">Unlocking potential through collaboration.</p>
      </div>
      <button className="flex items-center justify-between bg-primary text-gray-900 font-black text-[10px] uppercase tracking-wider px-6 py-4 rounded-2xl w-full hover:bg-white transition-all shadow-[0_0_20px_rgba(168,230,61,0.2)]">
...
const Col5Bar = () => (
  ...
  >
    ...
    <span className="text-foreground text-sm font-bold">Engineering project / 2026</span>
  </motion.div>
);
...
const ModuleCard = ({
  ...
  <motion.div
    ...
    className={`relative overflow-hidden bg-card border border-border rounded-[2rem] p-8 flex flex-col justify-between group cursor-pointer hover:border-[#a8e63d]/30 hover:shadow-lg hover:shadow-[#a8e63d]/5 transition-all ${
  ...
  >
    ...
    <div>
      ...
      <p className="text-foreground/50 text-sm leading-relaxed max-w-[240px]">{description}</p>
    </div>
...
const StepCard = ({
  ...
  <div className="relative p-8 rounded-[2rem] bg-card border border-border flex flex-col gap-6 group hover:border-[#a8e63d]/30 transition-all">
    <div className="w-16 h-16 rounded-2xl bg-primary/20 flex items-center justify-center border border-[#a8e63d]/20 text-primary group-hover:bg-primary group-hover:text-gray-900 transition-all">
    ...
    <div className="absolute top-8 right-8 text-6xl font-black text-foreground/5 select-none">{number}</div>
  </div>
);
  ...
  <section className="py-24 px-6 relative overflow-hidden">
    ...
    <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-4 p-4 rounded-2xl bg-muted border border-border">
              ...
              <div>
                <h4 className="text-foreground font-bold text-sm">Hardware Integration</h4>
                <p className="text-foreground/50 text-xs">Precise sensor calibration and firmware logic.</p>
              </div>
            </div>
            <div className="flex items-center gap-4 p-4 rounded-2xl bg-muted border border-border">
              <div className="w-12 h-12 rounded-xl bg-[#0d2b1d] flex items-center justify-center text-[#84cc16] shrink-0 border border-[#84cc16]/20">
              ...
              <div>
                <h4 className="text-foreground font-bold text-sm">Software Precision</h4>
                <p className="text-foreground/50 text-xs">Scalable real-time monitoring and analytics.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <motion.div
        ...
        className="relative"
      >
        <div className="relative z-10 p-8 rounded-[2.5rem] bg-gradient-to-br from-[#111111] to-[#0a0a0a] border border-border shadow-2xl">
          <Image 
    ...
    <div className="min-h-screen bg-background selection:bg-primary/30">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-10">
            <motion.h1
              ...
              className="text-5xl md:text-[4.5rem] font-black text-foreground leading-[1.1] mb-6 max-w-3xl mx-auto"
            ...
            <motion.p
              ...
              className="text-foreground/60 text-base max-w-md mx-auto leading-relaxed"
            >
            ...
            >
              <Link
                href="/dashboard"
                className="px-8 py-3.5 bg-gray-900 text-foreground font-bold rounded-full hover:bg-primary hover:text-gray-900 transition-all text-sm border border-gray-700"
              >
                View Dashboard
              </Link>
              <button className="flex items-center gap-2.5 px-8 py-3.5 bg-transparent border border-[#2e2e2e] text-foreground font-semibold rounded-full hover:border-[#a8e63d]/40 transition-all text-sm">
      ...
      <section id="modules" className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div>
              <p className="text-xs font-black uppercase tracking-[0.3em] text-primary mb-3">The Modules</p>
              <h2 className="text-4xl md:text-5xl font-bold text-foreground">Connected Ecosystem</h2>
            </div>
            <p className="max-w-md text-foreground/50 text-base leading-relaxed">
      ...
      <section className="py-24 px-6 bg-[#070707] border-y border-[#1a1a1a]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-xs font-black uppercase tracking-[0.3em] text-primary mb-3">How It Works</p>
            <h2 className="text-4xl md:text-5xl font-bold text-foreground">From sensor to dashboard</h2>
          </div>
      ...
      <section id="dashboard" className="py-24 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div>
            <p className="text-xs font-black uppercase tracking-[0.3em] text-primary mb-4">Dashboard</p>
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
              Everything in <span className="text-primary">one view</span>
            </h2>
            <p className="text-foreground/50 text-base mb-10 leading-relaxed">
            ...
            <ul className="space-y-5 mb-10">
              {[
                ...
                <li key={item} className="flex items-center gap-4 group">
                  <div className="w-6 h-6 rounded-full bg-primary/20 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-gray-900 transition-all border border-[#a8e63d]/20">
            ...
            <Link
              href="/dashboard"
              className="inline-flex items-center gap-2 px-7 py-3.5 border border-border rounded-full font-semibold text-sm text-foreground hover:bg-primary hover:text-gray-900 hover:border-[#a8e63d] transition-all"
            >
              Preview Dashboard
          ...
          <div className="relative">
            ...
            <div className="relative rounded-[2rem] overflow-hidden border border-border shadow-2xl bg-card">
              <div className="h-8 bg-[#0d0d0d] flex items-center px-5 gap-1.5 border-b border-border">
      ...
      {/* ── TEAM ── */}
      <section id="about" className="py-20 px-6 border-t border-border" style={{ background: "#050505" }}>
        <div className="max-w-7xl mx-auto">
          {/* 1 — Label + Heading */}
          ...
          <div className="mb-8 rounded-2xl px-6 py-5" style={{ background: "#0d0d0d", border: "1px solid rgba(255,255,255,0.06)", borderLeft: "3px solid #84cc16" }}>
            ...
            <p className="text-foreground font-bold text-base mt-2">[Supervisor Name]</p>
            <p className="text-foreground/50 text-sm">Department of Electrical &amp; Electronics Engineering</p>
            <p className="text-foreground/40 text-sm">Federal University Oye-Ekiti</p>
            <p className="text-foreground/40 text-xs italic mt-3 pt-3" style={{ borderTop: "1px solid rgba(255,255,255,0.04)" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
            ...
            <div className="rounded-2xl p-6 flex flex-col gap-4" style={{ background: "#0f0f0f", border: "1px solid rgba(255,255,255,0.06)" }}>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-foreground font-bold text-base">Faruna Victor</h3>
                  <p className="text-foreground/50 text-xs mt-0.5">Lead · Software &amp; Web Development</p>
                </div>
              </div>
              <div className="flex flex-wrap gap-2">
                {["Next.js", "Node.js", "PostgreSQL", "UI/UX"].map((tag) => (
                  <span key={tag} className="text-[11px] font-semibold px-2.5 py-1 rounded-md text-foreground/60" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.07)" }}>{tag}</span>
                ))}
              </div>
              <div className="flex gap-2">
                <a href="#" className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-bold text-foreground/60 hover:text-[#84cc16] transition-colors" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)" }}>
            ...
            <div className="rounded-2xl p-6 flex flex-col gap-4" style={{ background: "#0f0f0f", border: "1px solid rgba(255,255,255,0.06)" }}>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-foreground font-bold text-base">Ajayi Korede</h3>
                  <p className="text-foreground/50 text-xs mt-0.5">Co-Lead · Hardware &amp; IoT Integration</p>
                </div>
              </div>
              <div className="flex flex-wrap gap-2">
          ...
          <div className="text-center">
            ...
            <p className="text-foreground/60 text-base italic leading-relaxed max-w-xl mx-auto">
      ...
      {/* ── FOOTER ── */}
      <footer id="contact" className="py-14 border-t border-[#1a1a1a] px-6 bg-background">
